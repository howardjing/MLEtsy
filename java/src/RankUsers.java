...
public class RankUsers {
    public static void main(String args[]) {
        ...
        Users randomUsers = new Users("data/raw/randomUsersFavoriteItems.txt", false);
        ...
        //      Users testRandomUsers = new Users(randomUsersPath, false);
        //      Ranker test = new Ranker(testUser, testRandomUsers.users.get(0));
        //      // 
